...
This should allow you to directly import `src/patchnorm` in your notebook.
...
Run `python -m ipykernel install --user --name="patchnorm"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called patchnorm should be available in the
